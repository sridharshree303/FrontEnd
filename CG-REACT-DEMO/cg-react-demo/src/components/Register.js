...
const Register = (props) => {
    ...
    return ( <
        ...
        Link to = "/login"
        className = "btn btn-primary col-12" > Already registered ? Login < /Link> <
        /div> <
        /div >
...
//         axios.post('http://localhost:8082', appUser)
//             .then((response) => {
...
//                     <br /><br/>
//                     <input type="text" name="role" value={appUser.role} placeholder="Select role" onChange={handleChange} />
//                     <br /><br/>
